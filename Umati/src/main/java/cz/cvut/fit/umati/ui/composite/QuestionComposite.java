...
public class QuestionComposite extends CustomComponent {
	...
	public QuestionComposite() {
		...
		previousButton.addListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				// Previous
				try {
					ModelViewMapper.commitAll(ModelViewMapper.findViewClass(applicationContext, questionList.getActual()));
		...
		nextButton.addListener(new ClickListener() {
			...
			public void buttonClick(ClickEvent event) {
				...
				try {
					...
					questionList.toNext();
					showActualQuestionFromQueue();
				} catch (InvalidValueException | QuestionListException e) {
					getWindow().showNotification(e.getLocalizedMessage());
				}
			}
		});
	...
	private void showActualQuestionFromQueue() {
		...
		// CustomComponent
		CustomComponent viewComponent = ModelViewMapper.map(applicationContext, actualEntity);  
		
		// Set to the panel
		questionPanel.setContent(viewComponent);
