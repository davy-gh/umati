...
public class WebApiQuestion extends CustomComponent {
	...
	public OptionGroup getEndPointsType() {
	...
	private GridLayout buildMainLayout() {
		...
		mainLayout.addComponent(numericLabel, 0, 0);
		...
		mainLayout.addComponent(numericInputField, 1, 0);
		...
		mainLayout.addComponent(endPointsTypeLabel, 0, 1);
		...
		mainLayout.addComponent(endPointsType, 1, 1);
